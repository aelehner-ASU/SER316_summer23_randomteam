...
public class AppFrame_AboutBox extends JDialog implements ActionListener {
  ...
  String product = "Version "+App.VERSION_INFO + " (Build " + App.BUILD_INFO + ")"; //the symbols that are not displayed correctly
  ...
  private void jbInit() throws Exception  {    
    ...
    this.setTitle(Local.getString("About Level Up Gym"));
    setResizable(false);
    // Initialize Objects
