...
//        TaskDialog dlg = new TaskDialog(App.getFrame(), Local.getString("Schedule view"));
...
public class TaskPanel extends JFrame {
        ...
        JScrollPane overallScrollPane = new JScrollPane(overallScheduleTextArea);
        JScrollPane individualScrollPane = new JScrollPane(individualScheduleTextArea);
        ...
        viewOverallButton.addActionListener(new void ActionListener() {
        public void actionPerformed(ActionEvent e) {
