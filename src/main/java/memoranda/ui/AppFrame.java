...
public class AppFrame extends JFrame {
        ...
        public Action importNotesAction = new AbstractAction(Local.getString("Import multiple notes")) { // the symbols
                                                                                                         // that are not
                                                                                                         // displayed
                                                                                                         // correctly
        ...
        public Action importOneNoteAction = new AbstractAction(Local.getString("Import one note")) { // the symbols that
                                                                                                     // are not
                                                                                                     // displayed
                                                                                                     // correctly
        ...
        private void jbInit() throws Exception {
                ...
                this.workPanel.RoomUIB.addActionListener(setMenusDisabled);
        ...
        protected void ppExport_actionPerformed(ActionEvent e) {
                ...
                ProjectExportDialog dlg = new ProjectExportDialog(
                                App.getFrame(),
