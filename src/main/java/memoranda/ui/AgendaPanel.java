                ...
                if (d.equalsIgnoreCase("memoranda:events"))
                    ...
                    if (!dlg.CANCELLED) {
                        ...
                        txt = "<div style=\"background-color:"
                            +dlg.getStickerColor()+";font-size:"
                            +dlg.getStickerTextSize()+";color:"
                    ...
                    StickerExpand dlg =new StickerExpand(App.getFrame(),sticker,
                        backGroundColor,foreGroundColor,Local.getString(//cont.
                        "priority")+": "+Local.getString(priorities[sP]));
                    Dimension frmSize = App.getFrame().getSize();
                    ...
                    String id = d.split("#")[1];
                    Element pre_sticker = (Element)((Map)EventsManager
                        .getStickers()).get(id);
                    String sticker = pre_sticker.getValue();
                    ...
                    int size = Integer.parseInt(sticker.substring(sizeposition,
                        sizeposition+2));
                    System.out.println(size+" "+sizeposition);
                    int sP = Integer.parseInt(pre_sticker.getAttributeValue(
                        "priority"));
                    String backGroundColor=sticker.substring(backcolor,
                        sticker.indexOf(';',backcolor));
                    String foreGroundColor=sticker.substring(fontcolor,
                        sticker.indexOf(';',fontcolor));
                    StickerDialog dlg = new StickerDialog(App.getFrame(),//cont.
                        sticker.substring(first+1,last),backGroundColor,//...
                        foreGroundColor,sP,size);
                    Dimension frmSize = App.getFrame().getSize();
                    dlg.setSize(new Dimension(300,380));
                    Point loc = App.getFrame().getLocation();
                    dlg.setLocation((frmSize.width-dlg.getSize().width)/2+loc.x,
...
>>>>>>> origin/Task#80
                    ...
                    String name = JOptionPane.showInputDialog(parent,Local.//...
                        getString("Insert")+" "+Local.getString("file name:").
                        replace(':',' ') + Local.getString("to export"), null);
                    ...
                    String name = JOptionPane.showInputDialog(parent,Local.//...
                        getString("Insert")+" "+Local.getString("file name:").
                        replace(':',' ') + Local.getString("to import"), null);
