...
public class DailyItemsPanel extends JPanel {
    ...
    RoomUIBPanel RoomUIBPanel = new RoomUIBPanel(this);
    ...
    JTabbedPane RoomUIBTabbedPane = new JTabbedPane();
    Border border2;
    ...
    void jbInit() throws Exception {
        ...
        editorsPanel.add(RoomUIBPanel, "AGENDA");
        ...
        mainTabsPanel.add(RoomUIBTabbedPane, "AGENDATAB");
    ...
    public void updateIndicators(CalendarDate date, TaskList tl) {
        ...
        if (date.equals(CalendarDate.today())) {
            ...
            if (EventsScheduler.isEventScheduled()) {
                /*
                 * String evlist = "";
                 * for (Iterator it = EventsScheduler.getScheduledEvents().iterator();
                 * it.hasNext();) {
    ...
    public void selectPanel(String pan) {
        ...
        RoomUIBPanel.setActive(isAg);
        if (isAg)
            RoomUIBPanel.refresh(CurrentDate.get());
